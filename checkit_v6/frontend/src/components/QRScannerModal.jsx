    ...
    >
      <div
        className={`flex items-center gap-2 text-sm rounded-xl px-3 py-2.5 mb-4 ${
          status.type === 'success'
            ? 'bg-brand-50 dark:bg-brand-900/30 text-brand-800 dark:text-brand-300 border border-brand-300 dark:border-brand-700'
            : 'bg-brand-50 dark:bg-brand-900/30 text-brand-800 dark:text-brand-300 border border-brand-200 dark:border-brand-800'
        }`}
      >
        {status.type === 'success' ? (
      ...
      <div className="mt-4">
        ...
        <div className="flex gap-2">
          <input
            className="flex-1 border border-gray-200 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100 rounded-xl px-3 py-2 text-sm focus:outline-none focus:border-brand-500"
          ...
          <button
            onClick={applyManual}
            className="bg-brand-600 hover:bg-brand-700 text-white text-sm font-semibold px-4 rounded-xl transition-colors"
          >
            Aplicar
          </button>
        </div>
